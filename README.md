# Lombongo - Carteira de Pagamentos com Spring Boot

É uma aplicação que permite aos utilizadores realizar transações financeiras, como transferências de dinheiro, pagamentos de contas e gerenciamento de saldo.
